...
$GunvelikSorusuBul  = $db->prepare("SELECT * FROM SecQues WHERE id = ?");
$GunvelikSorusuBul->execute([$UyeBilgileri["SecurityQuestion"]]);
$GunvelikSorusu     = $GunvelikSorusuBul->fetch();
...
<body style="background-color:#004447">
    ...
    <div style="background-color:#F9F4D7 ; width:760px ; margin-left:auto ; margin-right:auto ; padding-left : 150px ; height : 400px; padding-top : 150px ; margin-top : 200px ; border-radius:20px">
        <form action="SifremiUnuttumSonuc2.php?ID=<?php echo FilterForNumber($UyeBilgileri["id"]); ?>" method="post">
            <table style="width:500px">
                <tr>
                    <td style="width:230px ; font-size : 20px ; font-weight:bold ; font-family:Gil-Sans ; color : #004447">Güvenlik Sorunuz</td>
                    <td style="width:20px">:</td>
                    <td><input style="width: 250px; height: 45px; color: #004447; font-size: 20px; font-weight: bold;border-radius:8px" type="text" placeholder="<?php echo $GunvelikSorusu["Soru"];  ?>"></td>
                </tr>
                <tr>
                    <td style="width:230px ; font-size : 20px ; font-weight:bold ; font-family:Gil-Sans ; color : #004447">Güvenlik Sorusu Cevabı</td>
                    <td>:</td>
                    <td><input style="width: 250px; height: 45px; color: #004447; font-size: 20px; font-weight: bold;border-radius:8px" type="password" name="SecAns"></td>
                </tr>
                <tr>
