      ...
      <div class="card-2">
        <table>
          <tr>
            ...
            <td class="bas_kısım" style="width: 250px; height: 100px"><a style="text-decoration:none ; color : black" href="GazeteEkleForm.php">GAZETE EKLE</a></td>
            <td style="width: 30px">&nbsp</td>
          </tr>
        </table>
        <table style="width:1150px">
            <form action="GazeteEkleSonuc.php" method="post">
                <tr style="height:90px">
                    <td style="width:350px ; height:40px"><b style="font-size : 20px">Gazete Adı</b></td>
                    <td style="width:30px ; height:40px">:</td>
                    <td style="width:500px ; height:40px"><input name="GazeteAdi" style="width:500px ; border:1px solid #004447; height:40px ; border-radius:15px ; padding:5px ; font-size : 20px" type="text"></td>
                </tr>
                <tr style="height:90px">
                    <td style="width:350px ; height:40px"><b style="font-size : 20px">Gazete Logo</b></td>
                    <td style="width:30px ; height:40px">:</td>
                    <td style="width:500px ; height:40px"><input name="GazeteLogo" style="width:500px ; border:1px solid #004447; height:40px ; border-radius:15px ; padding:5px ; font-size : 20px" type="text"></td>
                </tr>
                <tr style="width:90px">
