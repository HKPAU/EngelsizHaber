    ...
    <div class="content">
      <div class="card-2" style="overflow : auto ; height : 850px">
        ...
        <table>
          ...
          $GazeteOku->execute();
          $GazeteKontrol     = $GazeteOku->rowCount();
          ...
          <tr>
            ...
            <td style="width: 30px">&nbsp</td>
            <td style="width: 30px">&nbsp</td>
            <td style="width: 250px; height: 100px"><?php echo $Value["GazeteAdi"]; ?></td>
            <td style="width: 30px">&nbsp</td>
            <td style="width: 30px">&nbsp</td>
            <td style="width: 250px; height: 100px"><img style="width:250px ; height : 100px" src="../Images/<?php echo $Value["GazeteLogo"]; ?>" alt=""></td>
            <td style="width: 30px">&nbsp</td>
            <td style="width: 30px">&nbsp</td>
            <td style="width: 250px; height: 100px"><a href="GazeteSil.php?ID=<?php echo $Value["id"]; ?>"><img src="../Images/close-2.png" alt=""></a></td>
          </tr>
          <?php
            }
          }else{
