    ...
    <tr>
        <td>
            <table style="width:100% ; background-color : #E4A27E">
                <tr>
                    <td><img src="Images/speech-2.png" alt=""> </td>
                    <td align="right" style="font-size : 74px ; color : #004447 ; font-family : Gil-Sans">Siyaset Haberleri</td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td style="background-color : #F9F4D7 ; padding:10px">
            <table>
                ...
                $Limit                  = 5;
                $Gosterim               = 1;
                $SporHaberleriOku      = $db->prepare("SELECT * FROM Haberler WHERE IcerikTuruID = 3 ORDER BY EklenmeTarihi DESC");
