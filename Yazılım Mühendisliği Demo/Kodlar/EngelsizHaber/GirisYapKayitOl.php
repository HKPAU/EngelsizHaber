...
<body id="SingIN">
            ...
            <tr style="width: 100%; background-color: #F9F4D7; height: 100px;">
                ...
                <td id="SignINForm">
                    <form action="GirisYapSonuc.php" method="post">
                        ...
                        <br>
                        <img style="margin-bottom:5px" src="Images/confusion.png" alt=""> <a style="text-decoration:none" href="SifremiUnuttum.php">Şifremi Unuttum</a>
                    </form>
                </td>
            </tr>
        </table>
    ...
    <div>
        <table id="LogoAndRegistry">
            <tr>
                <td><img style="width: 650px; height: 650px;" src="Images/Logo.png" alt=""></td>
                <td>
                    <form id="RegisterForm" action="KayitOl.php" method="post">
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="width: 20px; height: 45px; color: #F9F4D7;">:</td>
                                <td><input type="password" name="Password" onblur="ControlPassword(this)"></td>
                            </tr>
                            <tr>
                                <td colspan="3"></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td style="width: 20px; height: 45px; color: #F9F4D7;">:</td>
                                <td><input type="text" name="EMail" id="EMail" onblur="Control(this)"></td>
                            </tr>
                            <tr>
                                <td colspan="3"></td>
                            </tr>
...
<script>
    ...
    function ControlPassword($Value){
        
        if($Value.value.length < 6){
            alert("Şifrenizin Uzunluğu En Az 6 Karakterli Olması Gerekir");
            return;
        }
    }
</script>
